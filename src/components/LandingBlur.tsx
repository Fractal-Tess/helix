const LandingBlur = () => {
  return (
    <svg width="1001" height="1001" viewBox="0 0 1001 1001" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <filter id="filter0_f_1370_60" x="0.957031" y="0.171387" width="1000" height="1000" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        ...
        <radialGradient id="paint0_radial_1370_60" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(500.957 500.171) rotate(90) scale(619.368)">
          <stop stopColor="#060010"/>
          <stop offset="1" stopColor="#060010" stopOpacity="0"/>
        </radialGradient>
      </defs>
    </svg>
  );
